...
var hideAlert = function hideAlert() {
  // after showing a while time, just disappear
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGhhbnQiLCJhIjoiY2w5em1qc3RuMGIyNjNxbXNhMm9rd3kxMCJ9.7WJJJK9CvpyIJFEydCK7Cw';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:2000/api/v1/users/updatePass' : 'http://localhost:2000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51Mk9tHCe63QG0a9uZmpBuDSWrRM0GcMnhDHfKuq03rRhPrg5irMaWAvNdLvYUzCa4u7FQmaNQksYqhf6yJfcaQRm00axOdp1ew');
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)("http://localhost:2000/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
...
var logOutBu = document.querySelector('.nav__el--logout');
...
if (logOutBu) {
  logOutBu.addEventListener('click', _login.logOut);
}
if (updateUserForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
